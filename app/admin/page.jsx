...
const TH = { padding: "0.75rem 1.5rem", textAlign: "left", fontWeight: 600, color: "#64748b", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "1px solid #e2e8f0" };
const TD = { padding: "0.875rem 1.5rem" };
    ...
    <div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <div className="card" style={{ padding: 0, overflow: "hidden" }}>
        <div style={{ padding: "1.25rem 1.5rem", borderBottom: "1px solid #e2e8f0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <h2 style={{ fontSize: "1rem", fontWeight: 700, color: "#0f172a", margin: 0 }}>Recent Students</h2>
          <a href="/admin/students" style={{ fontSize: "0.8125rem", color: "#6366f1", fontWeight: 600, textDecoration: "none" }}>View all →</a>
        </div>
